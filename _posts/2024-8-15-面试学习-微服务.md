...
- [微服务](#微服务)
  - [1.什么是微服务？](#1什么是微服务)
  - [2.微服务带来了哪些挑战？](#2微服务带来了哪些挑战)
  - [3.现在有哪些流行的微服务解决方案？](#3现在有哪些流行的微服务解决方案)
  - [4.说下微服务有哪些组件？](#4说下微服务有哪些组件)
  - [5.注册中心是用来干什么的？](#5注册中心是用来干什么的)
  - [6.SpringCloud 可以选择哪些注册中心？](#6springcloud-可以选择哪些注册中心)
  - [7.说下 Eureka、ZooKeeper、Nacos 的区别？](#7说下-eurekazookeepernacos-的区别)
  - [8.Eureka 实现原理了解吗？](#8eureka-实现原理了解吗)
  - [9.Eureka Server 怎么保证高可用？](#9eureka-server-怎么保证高可用)
  - [10.为什么微服务需要配置中心？](#10为什么微服务需要配置中心)
  - [11.SpringCloud 可以选择哪些配置中心？](#11springcloud-可以选择哪些配置中心)
  - [12.Nacos 配置中心的原理了解吗？](#12nacos-配置中心的原理了解吗)
  - [13.Nacos 配置中心长轮询机制？](#13nacos-配置中心长轮询机制)
  - [14.能说下 HTTP 和 RPC 的区别吗？](#14能说下-http-和-rpc-的区别吗)
    - [RPC了解吗？](#rpc了解吗)
  - [15.Feign 和 Dubbo 的区别呢？](#15feign-和-dubbo-的区别呢)
  - [16.说一下 Fegin?](#16说一下-fegin)
  - [17.为什么 Feign 第一次调用耗时很长？](#17为什么-feign-第一次调用耗时很长)
  - [18.Feign 怎么实现认证传递？](#18feign-怎么实现认证传递)
  - [19.Fegin 怎么做负载均衡？Ribbon?](#19fegin-怎么做负载均衡ribbon)
  - [20.说说有哪些负载均衡算法？](#20说说有哪些负载均衡算法)
  - [21.什么是服务雪崩？](#21什么是服务雪崩)
  - [22.什么是服务熔断？什么是服务降级？](#22什么是服务熔断什么是服务降级)
    - [什么是服务熔断？](#什么是服务熔断)
    - [什么是服务降级？](#什么是服务降级)
    - [有哪些熔断降级方案实现？](#有哪些熔断降级方案实现)
  - [23.Hystrix 怎么实现服务容错？](#23hystrix-怎么实现服务容错)
  - [24.Sentinel 怎么实现限流的？](#24sentinel-怎么实现限流的)
    - [Sentinel 采用的什么限流算法？](#sentinel-采用的什么限流算法)
    - [Sentinel 怎么实现集群限流？](#sentinel-怎么实现集群限流)
  - [25.什么是 API 网关？](#25什么是-api-网关)
  - [26.SpringCloud 可以选择哪些 API 网关？](#26springcloud-可以选择哪些-api-网关)
  - [27.Spring Cloud Gateway 核心概念？](#27spring-cloud-gateway-核心概念)
  - [28.为什么要用微服务链路追踪？](#28为什么要用微服务链路追踪)
  - [29.SpringCloud 可以选择哪些微服务链路追踪方案？](#29springcloud-可以选择哪些微服务链路追踪方案)
  - [30.Seata 支持哪些模式的分布式事务？](#30seata-支持哪些模式的分布式事务)
  - [31.了解 Seata 的实现原理吗？](#31了解-seata-的实现原理吗)
    - [Seata 的事务执行流程是什么样的？](#seata-的事务执行流程是什么样的)
    - [全局事务 ID 和分支事务 ID 是怎么传递的？](#全局事务-id-和分支事务-id-是怎么传递的)
    - [Seata 的事务回滚是怎么实现的？](#seata-的事务回滚是怎么实现的)
  - [32.你们的服务怎么做监控和告警？](#32你们的服务怎么做监控和告警)
  - [33.你们的服务怎么做日志收集？](#33你们的服务怎么做日志收集)
...
![架构演进简图](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/ac84270d25aa98f87940599f2484111e.png)
...
![微服务带来的挑战](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/7e200d81a785c6f6018ecd7cee33b51d.png)
...
![Dubbo工作原理图](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/6d622a72d299924fad87adcebeb7c1af.png)
...
![微服务组件示意图](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/99350e76ce2f763ed5ce5ba6594941f8.png)
...
**API 网关**：作为微服务架构的入口，统一暴露服务，并提供路由、负载均衡、安全认证等功能。常见的实现包括：
...
![注册中心示意图](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/cf3896a6c789eb0dd9c4c414f003ed7c.png)
...
![Eureka原理](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/477cde58e9553323d74ebac6d5a63079.png)
...
![Eureka Server](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/cbf6eee8064d0ece8abf8b611629136e.png)
...
![配置中心](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/1fe746722ca8f0d4ed608c1402fbd692.png)
...
![Nacos长轮询](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/16de67d4619e2844fb0812cf994cd7e7.png)
...
![HTTP和RPC](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/0ed1a1a1b1c6dd753abad1b4b51ed76b.png)
...
![Feign封装](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/d169125c01b90de79271a2ba4229283b.png)
...
![客户端负载均衡](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/ae4998231c351b393b025bfcab150844.png)

### 20.说说有哪些负载均衡算法？

常见的负载均衡算法包含以下几种：

![常见负载均衡算法](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/10f8e977199a2b42be5a5f3d47ca798f.png)
...
![服务雪崩](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/9608f6d00078e3059587d14fa1dad6e0.png)
...
![Hystrix服务容错六大机制](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/bfc1fcd689ccab76f23abc3cd1c6ddf3.png)
...
![Sentinel控制台](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/54206a2d5b5ab4f1387c2d344b5b9e5d.png)

限流控制：当请求到达时，Sentinel 会根据资源的限流规则判断是否需要进行限流控制。如果请求超过了限流阈值，则可以进行限制、拒绝或进行其他降级处理。

![Sentinel总体框架](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/ec903e569092136bb03d9e3a89e40474.png)
...
![Token Server和Client](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/a387826853b4c459a52a5762eeec8427.png)

### 25.什么是 API 网关？

API 网关（API Gateway）是一种中间层服务器，用于集中管理、保护和路由对后端服务的访问。它充当了客户端与后端服务之间的入口点，提供了一组统一的接口来管理和控制 API 的访问。

![网关示意图](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/544aa9123d085ae1b89bdf0adb8ae50d.png)
...
![Gateway原理](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/51faf0c8c742b1d86f2c4ac3cd3b8885.png)
...
![SpringCloud工作流程图](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/8b1109d802eccbcbb2f667648fb25505.png)
...
![SkyWalking界面](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/98e74c1a6d5e3a083c266ebb48051c67.png)
...
![Zipkin界面](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/4acc0c39bc776867b76f0ade4c3440b8.png)
...
![SkyWalking示例界面](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/882b9ae41162ba6bb7c41d9d7ad82736.png)
...
![Pinpoint示意图](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/df73e94d1eb19ca40d150788cee2c360.png)
...
![AT模式示意图](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/5069b45cedaab00a06ab5cc98a0baa6c.png)
...
![Seata TCC模式](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/d8131fd04bb31e3b0ca26016c302e3cb.png)
...
![SAGA模式状态机引擎](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/a36315dedde1aacdda94aebf58bbfd68.png)
...
![XA模式示意图](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/5614543d4fac09e7501379989a44a8c0.png)
...
![事务日志记录](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/9badf29259da5932defbce509d3b169e.png)
...
![Dashboard](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/250cb02220303993a2b842f5054aa51d.png)
...
![ELK流程](https://raw.githubusercontent.com/BugLeesir/image_host01/main/blogs_img/4f735b4934d90c3b55fc4b644d22f5c0.png)
