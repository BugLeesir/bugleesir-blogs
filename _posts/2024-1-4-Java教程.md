...
<!-- TOC -->
    ...
    - [接口](#接口)
        ...
        - [接口实现](#接口实现)
            - [接口举例](#接口举例)
    - [抽象类和接口区别](#抽象类和接口区别)
        - [1. 语法层面上的区别](#1-语法层面上的区别)
        - [2. 设计层面上的区别](#2-设计层面上的区别)
    - [拆箱装箱基本概念](#拆箱装箱基本概念)
    - [包装类型的必要性](#包装类型的必要性)
    - [装箱和拆箱举例](#装箱和拆箱举例)
    - [缓存池问题](#缓存池问题)
    ...
    - [（一） 工厂方法模式（Factory Method）](#一-工厂方法模式factory-method)
        - [1 、普通工厂模式](#1-普通工厂模式)
        - [2 、多个工厂方法模式](#2-多个工厂方法模式)
        - [3 、静态工厂方法模式](#3-静态工厂方法模式)
    ...
    - [native](#native)
        ...
        - [使用方法](#使用方法)
- [include <jni.h>](#include-jnih)
- [ifndef IncludedHelloWorld](#ifndef-includedhelloworld)
- [define IncludedHelloWorld](#define-includedhelloworld)
...
- [include <jni.h>](#include-jnih)
- [include <jni.h>](#include-jnih)
- [include "HelloWorld.h"](#include-helloworldh)
